...
const { indexView, editorialView, registroView, loginView,loginSuccessView, cadastroSuccessView, anuncioView, catalogoView, carrinhoView } = require('../controllers/viewsController.js');
...
router.get('/carrinho', carrinhoView);
